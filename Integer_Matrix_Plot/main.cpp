 ...
 * Author: khanh
 *
 * Created on October 3, 2015, 11:04 AM
 */
...
void get_Digit_Matrix(int digits, char (*matrix)[DIMENSION]);
void assign_Matrix(char (*assign_Matrix)[DIMENSION], char (*matrix)[DIMENSION]);
void append_Matrix(char (*assign_Matrix)[DIMENSION], char (*matrix)[DIMENSION], int count);
void print_Matrix(char (*matrix)[DIMENSION], int size);
/*
 * 
 */
int main() 
...
void append_Matrix(char (*display_Matrix)[DIMENSION], char (*matrix)[DIMENSION], int count)
{
...
void get_Digit_Matrix(int value, char (*matrix)[DIMENSION] )
{    
...
void assign_Matrix(char (*assignMatrix)[DIMENSION], char (*matrix)[DIMENSION])
{
    int i = 0, j = 0;
    for(i = 0; i < DIMENSION; i++)
